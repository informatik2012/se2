...
public interface VerleihService extends ObservableService
{
	...
	/**
	 * Setzt einen Vormerker in die Liste
	 * 
	 * @param kunde Ein Vormerker
	 * @param medium Ein Medium aus dem Bestand
	 * 
	 * @return true, wenn vormerken moeglich, sonst false
	 * 
	 * @require istVormmerkenMoeglich(Medium, Kunde)
	 */
	boolean vormerkeAn(Kunde kunde, List<Medium> medium);
	
	/**
	 * Nimmt einen Vormerker von der Liste
	 * 
	 * @param medium Ein Medium aus dem Bestand
	 * @param kunde Ein Vormerker aus der Liste
	 * 
	...
	/**
	 * Prüft ob ein Kunde ein bestimmtes Medium ausleihen kann
	 * 
	 * @param medien Medien aus dem Bestand
	 * @param kunde Ein Kunde
	 * 
	 * @return true, falls der Kunde das Medium ausleihen kann, sonst false
	 * 
	 * @require medien != null
	 * @require kunde != null  
	 */
	boolean kannKundeEntleihenMedien(List<Medium> medien, Kunde kunde);
	 ...
	 *
	 * @require mediumImBestand(medium) != null
	 */
	boolean istVorgemerkt(Medium medium);
	
	/**
	 * Prüft ob mehrere Medien vorgemerkt werden können
	 * 
	 * @param medium Ein Medien aus dem Bestand
	 * @param kunde Ein Kunde 
	 * 
	 * @return true wenn das vormerken moeglich ist, sonst false
	 * 
	 * @require medium != null
	 * @require kunde != null
	 */
	boolean istVormerkenMoeglich(List<Medium> medium, Kunde kunde);

	/**
	 * Prüft ob ein Medium vorgemerkt werden kann
	 * 
	 * @param medium Ein Medien aus dem Bestand
	 * @param kunde Ein Kunde 
	 * 
